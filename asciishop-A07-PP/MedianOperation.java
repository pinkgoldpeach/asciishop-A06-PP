...
* die Pixel nach ihrem `Helligkeitswert' sortiert und dann der Median
*  (also das in der sortierten Liste in der Mitte stehende Zeichen) als neues Pixel im Mittelpunkt des Blocks gesetzt.
*/
...
/** put all pixels (of a 3*3 box) in an array and sort the array. 
* set the pixel in the middle to the value (=char) of the middle of the array
*/
